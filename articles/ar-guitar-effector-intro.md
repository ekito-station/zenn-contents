---
title: "ARギターエフェクターをMeta QuestとAbleton Liveで作ってみた"
emoji: "🎸"
...
https://youtu.be/wLX4vHpueWQ?feature=shared
...
仕組みとしては，ギターの先から飛ばしたレーザー^[ギターの先からレーザーといえば，B'zのLOVE PHANTOMのライブパフォーマンス！]がARオブジェクトに当たるとエフェクターがONになってギターの音が変化するというものです．
...
https://youtube.com/shorts/p2rnRnbST_o?feature=shared
